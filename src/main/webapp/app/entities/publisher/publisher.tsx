...
import { getEntities, reset } from './publisher.reducer';
...
export type IPublisherState = IPaginationBaseState;

export class Publisher extends React.Component<IPublisherProps, IPublisherState> {
  state: IPublisherState = {
  ...
  render() {
    const { publisherList, match, isAdmin } = this.props;
    return (
      <div>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="bookmanagerrmh2App.publisher.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('distribution')}>
                    <Translate contentKey="bookmanagerrmh2App.publisher.distribution">Distribution</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('localization')}>
              ...
              <tbody>
                {publisherList.map((publisher, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`bookmanagerrmh2App.Distribution.${publisher.distribution}`} />
                    </td>
